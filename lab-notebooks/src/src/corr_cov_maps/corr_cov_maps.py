# This script calculates the correlation between indices time series and anomaly 
# time series, variance and mean height, at each longitude/latitude grid point. Methods 
# used are both Pearson and Spearman rank correlations.
